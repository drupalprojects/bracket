 ...
 */
drupal_add_css(drupal_get_path('module', 'bracket') . '/designs/se4champ/bracket-se4champ.css', 'theme', 'all', FALSE);
?>
...
<div class="bracket-block">
  ...
  <div id="round-1" class="bracket-round bracket-round-left">
    <div class="bracket-round-comment"><?php print $node->round[1]->comment ?></div>
